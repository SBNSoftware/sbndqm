...
#ifndef SBNDQM_DECODE_TRIGGER_DETAIL_KEYVALUESDATA_H
#define SBNDQM_DECODE_TRIGGER_DETAIL_KEYVALUESDATA_H
...
#endif // SBNDQM_DECODE_TRIGGER_DETAIL_KEYVALUESDATA_H
