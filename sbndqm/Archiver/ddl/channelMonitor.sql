...
CREATE OR REPLACE FUNCTION MONMON(GROUP_NAME CHARACTER, 
       	  	  	          METRIC     CHARACTER, 
                                  MTYPE      INTEGER,
                                  CH1        INTEGER,
                                  CHN        INTEGER)
...
$BODY$
  ...
  BEGIN
    ...
    EXECUTE FORMAT('
      ...
      WHILE CTR <= CHN LOOP
        EXECUTE FORMAT('
          INSERT INTO MONITOR_MAP VALUES (%L,%L,%L,%L,%L,3600,NOW())
...
SELECT MONMON(:GROUP_NAME,:METRIC,:MONITOR_TYPE,:CH1,:CHN);
