...
//  sbndaq::sendMetric("1 ETRIG", oneETRIG, "oneETRIG", oneETRIG, 0, artdaq::MetricMode::LastPoint); 
//  sbndaq::sendMetric("1 CRT T1 Reset", oneCRT, "oneCRT", oneCRT, 0, artdaq::MetricMode::LastPoint);   
//  sbndaq::sendMetric("~10 FTRIG", manyFTRIG, "manyFTRIG", manyFTRIG, 0, artdaq::MetricMode::LastPoint);  
//  sbndaq::sendMetric("1 BES", oneBES, "oneBES", oneBES, 0, artdaq::MetricMode::LastPoint);  
//  sbndaq::sendMetric("1 RWM", oneRWM, "oneRWM", oneRWM, 0, artdaq::MetricMode::LastPoint);  
//  sbndaq::sendMetric("RWM-BES constant", RWM_BES_const, "RWM_BES_const", RWM_BES_const, 0, artdaq::MetricMode::LastPoint);  
//  sbndaq::sendMetric("CRT T1-BES constant", CRT_BES_const, "CRT_BES_const", CRT_BES_const, 0, artdaq::MetricMode::LastPoint);  
//  sbndaq::sendMetric("ETRIG-BES ~1.6us", ETRIG_BES_diff, "ETRIG_BES_diff", ETRIG_BES_diff, 0, artdaq::MetricMode::LastPoint);  
//  sbndaq::sendMetric("ETRIG-RWM ~1.6us", ETRIG_RWM_diff, "ETRIG_RWM_diff", ETRIG_RWM_diff, 0, artdaq::MetricMode::LastPoint);  
//  sbndaq::sendMetric("ETRIG-FTRIG ~3ms", ETRIG_FTRIG_diff, "ETRIG_FTRIG_diff", ETRIG_FTRIG_diff, 0, artdaq::MetricMode::LastPoint);  
//  sbndaq::sendMetric("BES-FTRIG ~ 3ms", BES_FTRIG_diff, "BES_FTRIG_diff", BES_FTRIG_diff, 0, artdaq::MetricMode::LastPoint);  
//  sbndaq::sendMetric("Channel # = Channel name", oneETRIG, "oneETRIG", oneETRIG, 0, artdaq::MetricMode::LastPoint);  
//  sbndaq::sendMetric("Channel populated", nch0, "ch0exists", ch0exists, 0, artdaq::MetricMode::LastPoint);  
//  sbndaq::sendMetric("Channel populated", nch1, "ch1exists", ch1exists, 0, artdaq::MetricMode::LastPoint); 
//  sbndaq::sendMetric("Channel populated", nch2, "ch2exists", ch2exists, 0, artdaq::MetricMode::LastPoint); 
//  sbndaq::sendMetric("Channel populated", nch3, "ch3exists", ch3exists, 0, artdaq::MetricMode::LastPoint); 
//  sbndaq::sendMetric("Channel populated", nch4, "ch4exists", ch4exists, 0, artdaq::MetricMode::LastPoint);  
