...
namespace geo {
  ...
  static bool sortAuxDetSBNDQM(const AuxDetGeo* ad1, const AuxDetGeo* ad2) {
  ...
  static bool sortAuxDetSensitiveSBNDQM(const AuxDetSensitiveGeo* ad1,
  ...
  void CRTGeoObjectSorter::SortAuxDets(
    ...
    std::sort(adgeo.begin(), adgeo.end(), sortAuxDetSBNDQM);
  }

  //----------------------------------------------------------------------------
  void CRTGeoObjectSorter::SortAuxDetSensitive(
      std::vector<geo::AuxDetSensitiveGeo*> & adsgeo) const {
    std::sort(adsgeo.begin(), adsgeo.end(), sortAuxDetSensitiveSBNDQM);
  }
