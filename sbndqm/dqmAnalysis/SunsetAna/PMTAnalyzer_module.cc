...
class sunsetAna::PMTAnalyzer : public art::EDAnalyzer {
public:
...
sunsetAna::PMTAnalyzer::PMTAnalyzer(fhicl::ParameterSet const& p)
  : EDAnalyzer{p}  // ,
...
void sunsetAna::PMTAnalyzer::analyze(art::Event const& e)
{
  // Implementation of required member function here.
}

DEFINE_ART_MODULE(sunsetAna::PMTAnalyzer)
