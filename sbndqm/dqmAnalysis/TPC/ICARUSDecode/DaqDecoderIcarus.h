...
class daq::DaqDecoderIcarus : public art::EDProducer {
public:
  explicit DaqDecoderIcarus(fhicl::ParameterSet const & p);
  // The compiler-generated destructor is fine for non-base
  // classes without bare pointers or other resource use.

  // Plugins should not be copied or assigned.
  DaqDecoderIcarus(DaqDecoderIcarus const &) = delete;
  DaqDecoderIcarus(DaqDecoderIcarus &&) = delete;
  DaqDecoderIcarus & operator = (DaqDecoderIcarus const &) = delete;
  DaqDecoderIcarus & operator = (DaqDecoderIcarus &&) = delete;
